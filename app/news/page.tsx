...
const newsArticles = [
  {
    ...
    excerpt:
      "New clinical trials demonstrate significant improvement in cognitive function with innovative drug therapy targeting amyloid plaques.",
    category: "Neurology",
    ...
    featured: true,
    tags: ["Alzheimer's", "Clinical Trial", "Neurology", "Drug Development"],
    isFavorited: false,
  },
  {
    id: 2,
    title: "Revolutionary Heart Surgery Technique Reduces Recovery Time by 50%",
    excerpt:
      "Minimally invasive cardiac procedure using robotic assistance shows remarkable outcomes in recent patient studies.",
    category: "Cardiology",
    ...
    featured: true,
    tags: ["Cardiology", "Surgery", "Innovation", "Recovery"],
    isFavorited: true,
  },
  {
    id: 3,
    title: "AI-Powered Diagnostic Tool Achieves 95% Accuracy in Cancer Detection",
    excerpt:
      "Machine learning algorithm outperforms traditional screening methods in early-stage cancer identification across multiple organ systems.",
    category: "Oncology",
    ...
    featured: false,
    tags: ["AI", "Cancer", "Diagnostics", "Technology"],
    isFavorited: false,
  },
  {
    id: 4,
    title: "New Guidelines for Diabetes Management Released by Medical Association",
    excerpt:
      "Updated recommendations include personalized treatment approaches and continuous glucose monitoring for improved patient outcomes.",
    ...
    featured: false,
    tags: ["Diabetes", "Guidelines", "Treatment", "Management"],
    isFavorited: false,
  },
  {
    id: 5,
    title: "Mental Health Apps Show Significant Impact on Patient Wellbeing",
    excerpt:
      "Large-scale study reveals digital therapeutic interventions can effectively supplement traditional mental health treatment.",
    ...
    featured: false,
    tags: ["Mental Health", "Digital Health", "Apps", "Wellbeing"],
    isFavorited: true,
  },
]
