...
export default function HomePage() {
  ...
  const healthTips = [
    {
      tip: "Stay hydrated! Drinking 8 glasses of water daily helps maintain proper kidney function, supports healthy skin, and boosts your energy levels. Start your morning with a glass of water to kickstart your metabolism.",
      proTip: "💡 Pro tip: Add a slice of lemon for extra vitamin C and better taste!",
    },
    {
      tip: "Get 7-9 hours of quality sleep each night. Good sleep strengthens your immune system, improves memory, and helps regulate hormones that control hunger and stress.",
      proTip: "💡 Pro tip: Keep your bedroom cool (60-67°F) for optimal sleep quality!",
    },
    {
      tip: "Take a 10-minute walk after meals. This simple habit can help regulate blood sugar levels, improve digestion, and boost your mood through natural endorphin release.",
      proTip: "💡 Pro tip: Walking outdoors provides additional vitamin D from sunlight!",
    },
    {
      tip: "Practice deep breathing for 5 minutes daily. Deep breathing reduces stress hormones, lowers blood pressure, and can improve focus and mental clarity throughout your day.",
      proTip: "💡 Pro tip: Try the 4-7-8 technique: inhale for 4, hold for 7, exhale for 8!",
    },
    {
      tip: "Eat a rainbow of fruits and vegetables. Different colored produce provides various antioxidants and nutrients that support immune function and reduce inflammation.",
      proTip: "💡 Pro tip: Aim for at least 5 different colors on your plate each day!",
    },
  ]
  ...
  return (
    <PageLayout>
      ...
      <SectionContainer
        background="green"
        size="xl"
        className="relative overflow-hidden bg-gradient-to-br from-green-50 to-green-100"
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <Link href="/ai-assistant">
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-gray-300 bg-white hover:bg-gray-50 px-8 py-3 text-lg w-full sm:w-auto text-gray-900"
                  >
            ...
            <div
              className={`relative flex items-center justify-center transition-all duration-1000 delay-500 ${isVisible ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}
            >
              {/* Large Circle */}
      ...
      <SectionContainer background="white" size="md" className="bg-white">
        <div className="max-w-6xl mx-auto">
          <div
            className={`text-center mb-8 transition-all duration-1000 delay-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
          ...
          {/* Statistics Grid */}
          <div
            className={`grid grid-cols-2 lg:grid-cols-4 gap-6 transition-all duration-1000 delay-900 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
            <Card className="text-center p-6 border-gray-200 hover:border-green-200 transition-colors bg-white">
      ...
      <SectionContainer background="green" size="md" className="bg-gradient-to-br from-green-50 to-green-100">
        <div className="max-w-4xl mx-auto">
          <Card
            className={`bg-white backdrop-blur-sm border border-gray-200 shadow-lg transition-all duration-1000 delay-1100 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-2xl font-bold text-gray-900">Health Tip of the Day</h3>
                    <Button
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-4">{healthTips[currentTipIndex].tip}</p>
                  <div className="text-sm text-gray-500">{healthTips[currentTipIndex].proTip}</div>
                </div>
              </div>
            </CardContent>
          </Card>
      ...
      <SectionContainer background="white" size="lg" className="bg-white">
        <div className="max-w-6xl mx-auto">
          <div
            className={`text-center mb-12 transition-all duration-1000 delay-1300 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
          ...
          <div
            className={`grid lg:grid-cols-2 gap-12 items-center transition-all duration-1000 delay-1500 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
              ...
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 shadow-lg border border-gray-200">
                <div className="bg-white rounded-xl shadow-md p-6 space-y-4 border border-gray-100">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-green-50 rounded-lg p-3 mr-8 border border-green-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <Card className="p-6 border-gray-200 hover:border-green-200 transition-colors bg-white">
                <CardContent className="p-0">
